...
import { ifShowCaptcha, getCaptcha, getSsoConfig, getRedirectURL, getRedirectURLCAS, getRedirectURLOAuth, authLoginWithPass, getRSAConfig } from '@/services/login';
import './login.less';
...
export default function Login() {
  ...
  const login = async () => {
    ...
    authLoginWithPass(username, authPassWord, captchaidRef.current!, verifyvalue)
      .then((res) => {
        const { dat, err } = res;
